function result() {
    ...
    let result = '';
            ...
            console.log(result);}
            if (tempFahr < 54 && eventType.toLowerCase() === 'semi-formal'){
            result = makeText(tempFahr, eventType, clothingEventType['semi-formal']) + ' a coat.';
            console.log(result);}
             if (tempFahr < 54 && eventType.toLowerCase() === 'formal'){
    ...
    /*======================================*/
                    ...
                    if (tempFahr >= 54 && tempFahr <=70 && eventType.toLowerCase() === 'casual'){
            result = makeText(tempFahr, eventType, clothingEventType.casual) + ' a jacket.';
            console.log(result);}
            if (tempFahr >= 54 && tempFahr <=70 && eventType.toLowerCase() === 'semi-formal'){
            result = makeText(tempFahr, eventType, clothingEventType['semi-formal']) + ' a jacket.';
            console.log(result);}
             if (tempFahr >= 54 && tempFahr <=70 && eventType.toLowerCase() === 'formal'){
